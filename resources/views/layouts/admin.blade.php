...
<body class="font-sans antialiased">
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-green-200 md:w-64 dark:text-gray-200 dark:bg-green-700"
            x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <!-- Nama salon -->
                <a href="#"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">Susi's Salon
                    </a>
                <!-- Tombol untuk menampilkan menu navigasi pada tampilan mobile -->
                <button class="rounded-lg md:hidden focus:outline-none focus:shadow-outline" @click="open = !open">
                    <svg fill="currentColor" viewBox="0 0 20 20" class="w-6 h-6">
                        <!-- Ikon menu ketika menu ditutup -->
                        <path x-show="!open" fill-rule="evenodd"
                            d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z"
                            clip-rule="evenodd"></path>
                        <!-- Ikon menu ketika menu dibuka -->
                        <path x-show="open" fill-rule="evenodd"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <div @click.away="open = false" class="relative" x-data="{ open: false }">
                    <!-- Tombol untuk menampilkan menu dropdown pengguna -->
